/*! v5.0.0.9 | pageoffice.js for asp.net core | (c) 2016, 2020 Beijing zhuozheng zhiyuan software, Inc.*/
...
var POBrowser = {
    ...
    getRootPath: function () {
        ...
        var index = pathName.indexOf("/pageoffice/js/pageoffice.js");
    ...
    showInstallDlg: function () {
        if (confirm("您需要安装PageOffice来打开文档。现在立即安装PageOffice吗？\r\n注意：安装完成后，请重新访问当前页面。")) {
            window.location.href = this.getRootPath() + "/pageoffice/posetup.exe"
        }
    },
    openWindow: function (strURL, strOptions, strArgument) {
        ...
        zsxmlhttp.onload = function () {
            ...
            if (strData.indexOf('"name":"jsonx"') > 0) {
                ...
                bPOIsInstalled = true;
                po_ajax({
                    url: POBrowser.getRootPath() + "/pageoffice/server.aspx",
                    type: "POST",
...
POBrowser.addCssByLink(POBrowser.getRootPath() + "/pageoffice/js/pobstyle.css");
POBrowser.checkSSL();
var poEvent = {};
